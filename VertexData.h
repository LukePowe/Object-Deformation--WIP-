...
{
	-0.45f,  0.45f, 1.0f, 0.0f, 0.0f, 3.0f, // Coordinates(X,Y),COLOUR RGB, number of sides
	
	
	
	
	-0.45f, -0.45f, 1.0f, 1.0f, 0.0f, 20.0f,
	 0.45f, -0.45f, 1.0f, 1.0f, 1.0f, 30.0f,
	 0.45f,  0.45f, 0.0f, 0.0f, 1.0f, 40.0f
};